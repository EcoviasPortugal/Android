...
public class Mapa extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LatLng saldanha = new LatLng(38.7337835895756,-9.14485824872606);

        map.setMyLocationEnabled(true);
        map.moveCamera(CameraUpdateFactory.newLatLngZoom(saldanha, 13)); //faz zoom ao ponto de 13 vezes

        map.addPolyline(new PolylineOptions().geodesic(true)
        		.add(new LatLng(38.7337835895756,-9.14485824872606)) //Saldanha, início na estátua
